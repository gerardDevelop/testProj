...
class BootScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('testprojectile', 'assets/projectiles/testprojectile.png');

        this.load.image('tiles', '../assets/stardew_spring_tileset.png');

        this.load.tilemapTiledJSON('map', '../assets/tilemaps/largemap.json');

        this.load.spritesheet('warrior', 'assets/sprites/soldier4.png', 
        ...
        this.load.spritesheet('priest', 'assets/sprites/priest.png', 
            { frameWidth: 32, frameHeight: 32 });

        this.load.spritesheet('nuclear1', 'assets/sprites/nuclear1.png', 
      ...
      this.load.spritesheet('priest', 
        'assets/sprites/priest.png',
        { frameWidth: 64, frameHeight: 64 }
      );
      */
